...
export type ConfigNames = 'renton/ignores' | 'renton/javascript/setup' | 'renton/javascript/rules' | 'renton/imports/rules' | 'renton/comments/setup' | 'renton/comments/rules' | 'renton/command/rules' | 'renton/perfectionist/rules' | 'renton/node/rules' | 'renton/jsdoc/rules' | 'renton/jsx/setup' | 'renton/typescript/setup' | 'renton/typescript/rules' | 'renton/stylistic/rules' | 'renton/regexp/rules' | 'renton/test/setup' | 'renton/test/rules' | 'renton/jsonc/rules' | 'renton/sort/package-json' | 'renton/sort/tsconfig-json' | 'renton/pnpm/package-json' | 'renton/pnpm/pnpm-workspace-yaml' | 'renton/yaml/rules' | 'renton/markdown/setup' | 'renton/markdown/parser' | 'renton/unicorn/rules' | 'renton/disables/scripts' | 'renton/disables/cli' | 'renton/disables/bin' | 'renton/disables/dts' | 'renton/disables/cjs' | 'renton/disables/config-files'
